...
- HTTP/3 request-body routing is intentionally still narrow: methods that need DATA frame bodies are rejected until the H3 request-body path lands, while HTTP/1 and HTTP/2 keep the full body-handling surface.
