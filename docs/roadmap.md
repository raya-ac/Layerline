...
6. Native TLS termination. Initial TLS 1.3 TCP termination, ALPN, configured ECDSA/RSA certificate loading, HTTP/1.1 over TLS, and HTTP/2 over TLS are implemented.
